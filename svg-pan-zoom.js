...
module.exports = {
  enable: function(instance) {
    ...
    if (!styleEl) {
      ...
      style.textContent = '.svg-pan-zoom-control { cursor: pointer; fill: transparent; fill-opacity: 0.333; } .svg-pan-zoom-control:hover { fill-opacity: 0.8; } .svg-pan-zoom-control-background { fill: transparent; fill-opacity: 0.5; } .svg-pan-zoom-control-background { fill-opacity: 0.8; }'
...
ShadowViewport.prototype.init = function(viewport, options) {
  ...
  // ViewBox
  this.viewBox = {x: 0, y: 0, width: 1400, height: 1300}
  this.cacheViewBox()
